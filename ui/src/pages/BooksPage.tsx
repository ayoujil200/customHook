...
export const BooksPage = () => {
    ...
    const handleDelete = (bookId, e) => {
        axios.delete('http://localhost:8080/api/v1/books/' + bookId)
            .then(() => {
                fetchBooks();
                toast.warning('your book deleted successfuly :)', {
            ...
            <div class="relative overflow-x-auto">
                <div class="flex m-2 items-center">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" onChange={handleCategoriesChange} id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="search by categories (category1,category2,...)" required />
                    </div>
                </div>
                <div class="flex m-2 items-center">
                    <label for="simple-search" class="sr-only">Search</label>
                    <div class="relative w-full">
                        ...
                        <input type="text" onChange={handleTitlesChange} id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="search by titles (title1,title2,...)" required />
                    </div>
                </div>
